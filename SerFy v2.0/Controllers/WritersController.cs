...
namespace SerFy_v2._0.Controllers
{
    public class WritersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Photograph,Place_DB,MiniBio")] Writer writer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Photograph,Place_DB,MiniBio")] Writer writer)
        {
            if (ModelState.IsValid)
            {
